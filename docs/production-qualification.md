...
## 3. Known deferred items at time of writing
BMV-001 credential rotation; live Stripe cutover + live €99 Price; Cloudflare
Turnstile keys; `SENTRY_DSN`; analytics key; localization (FR/DE); catalog-source
consolidation. Each is safe-by-default (dormant/authorized-deferral) until activated.
