...
export const metadata: Metadata = { title: "Verified software savings", description: "Confirmed software deals won through BeatMyVendor, published only with buyer consent.", alternates: { canonical: "/wins" } };
