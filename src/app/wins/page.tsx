...
export const metadata: Metadata = { title: "Verified software savings", description: "Confirmed software deals won through BeatMyyVendor, published only with buyer consent.", alternates: { canonical: "/wins" } };
