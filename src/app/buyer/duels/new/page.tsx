...
export default async function NewDuelPage() {
  ...
  return <DashboardShell area="Buyer" organization={organization.name}>
    ...
    <div className="dashboard-heading"><div><span className="eyebrow">Start a Duel</span><h1>Turn your current contract into leverage.</h1><p className="heading-copy">Save a draft at any time. Submitted duels stay private while VendorDuel verifies the opportunity.</p></div><span className="badge">About 5 minutes</span></div>
