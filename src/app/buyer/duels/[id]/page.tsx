...
const statusCopy: Record<string, string> = {
  draft: "Finish the brief and submit it when you are ready.", pending_verification: "VendorDuel is checking the opportunity before it goes live.",
  ...
  rejected: "VendorDuel needs updated information before this can proceed."
};
