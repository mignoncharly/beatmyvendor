...
export default async function OnboardingPage({ searchParams }: { searchParams: Promise<{ role?: string; next?: string }> }) {
  ...
  return (
    <section className="onboarding-shell">
      ...
      <div className="auth-card wide"><span className="card-kicker">WORKSPACE SETUP</span><h2>How will you use BeatMyVendor?</h2><OnboardingForm initialKind={initialKind} next={next} /></div>
    </section>
  );
}
