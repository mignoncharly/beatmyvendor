...
export const metadata: Metadata = { title: "Pricing", description: "VendorDuel is free for buyers. Vendors pay €99.99 only when selected for an introduction.", alternates: { canonical: "/pricing" } };
