...
export const metadata: Metadata = { title: "Pricing", description: "BeatMyVendor is free for buyers. Vendors pay €99.99 only when selected for an introduction.", alternates: { canonical: "/pricing" } };
