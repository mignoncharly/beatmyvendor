...
const templates: Record<string, Copy> = {
  email_verification: {
    subject: "Your secure VendorDuel sign-in link",
    eyebrow: "Secure access",
    headline: "One click. You’re in.",
    summary: "Use the secure link below to sign in and continue building your VendorDuel workspace.",
    detail: "For your security, this link is intended only for you and expires automatically. VendorDuel will never ask you to send a password, payment detail, or verification document by email.",
  ...
  offers_ready: {
    subject: "Your VendorDuel comparison is ready",
  ...
  introduction_completed: {
    subject: "Your VendorDuel introduction is ready",
  ...
  deal_confirmation: {
    subject: "How did your VendorDuel introduction progress?",
    ...
    detail: "Your commercial outcome stays private. VendorDuel publishes a verified Win only after separate, explicit consent.",
    cta: "Confirm the outcome",
    path: "/buyer/introductions"
  },
  vendor_approved: {
    subject: "Your VendorDuel vendor workspace is approved",
  ...
  challenge_submitted: {
    ...
    summary: "VendorDuel recorded and versioned your commercial terms for this Duel.",
  ...
  payment_receipt: {
    subject: "Receipt for your VendorDuel introduction",
    eyebrow: "Payment confirmed",
    headline: "Your introduction payment is complete.",
    summary: "Stripe confirmed the one-time VendorDuel introduction payment.",
  ...
  payment_failed: {
    subject: "Your VendorDuel payment was not completed",
  ...
  reported_vendor: {
    ...
    summary: "A VendorDuel user submitted a report concerning a vendor organization.",
  ...
  data_request_received: {
    subject: "We received your VendorDuel privacy request",
    eyebrow: "Data rights",
...
const fallback: Copy = {
  subject: "VendorDuel update",
  eyebrow: "Marketplace update",
  headline: "There’s an update in your workspace.",
  summary: "A VendorDuel activity related to your account is ready to review.",
...
export function renderBrandedEmail(templateKey: string, payload: Payload = {}, context: EmailContext = {}) {
  ...
  const html = [
    ...
    "<td style=\"font-size:18px;font-weight:900;letter-spacing:-.02em;color:#FFFDF7\"><span style=\"display:inline-block;color:#171713;background:#D9FF43;padding:5px 8px;margin-right:9px;border-radius:5px\">V</span>VENDORDUEL</td>",
    ...
    "<strong style=\"color:#2E2F2A\">VendorDuel</strong> · Software buying, reversed.<br>This operational message was sent because of activity in your VendorDuel account or workspace. Never send passwords, card details, or verification documents by email.",
    "</td></tr></table></td></tr></table></body></html>"
  ].join("");

  const text = [
    "VENDORDUEL", meta, "", greeting, "", copy.headline, "", copy.summary, "", copy.detail, "",
    copy.cta + ": " + actionUrl, "", "VendorDuel · Software buying, reversed.",
